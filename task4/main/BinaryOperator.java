...
public abstract class BinaryOperator extends ImplExpression {
    ...
    public boolean isAxiom(Expression a, Map<Integer, Expression> m) {
        return compareTypes(a) && left.isAxiom(((BinaryOperator) a).left, m) && right.isAxiom(((BinaryOperator) a).right, m);
    }
    ...
    public boolean equalTrees(Expression other) {
        return compareTypes(other) && ((BinaryOperator) other).left.equalTrees(left) && ((BinaryOperator) other).right.equalTrees(right);
    }
